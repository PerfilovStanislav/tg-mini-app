...
const productService = new ProfileService();
const { initDataUnsafe } = useWebApp();
// const { initDataUnsafe } = useWebAppBiometricManager();
...
onMounted(() => {
    productService.getProfiles().then((data) => (products.value = data));
});
        ...
        <div class="col-12 lg:col-6 xl:col-3">
            <div class="card mb-0">
                <div class="flex justify-content-between mb-3">
                    <div>
                        <span class="block text-500 font-medium mb-3">{{ data.tg }}</span>
